...
##### **Step 3.4.1: 工作專案時間軸頁面**
- [ ] 創建 WorkProjects 頁面
- [ ] 整合 InteractiveTimeline 組件
- [ ] 配置工作專案路由
- [ ] 實現時間軸完整視圖

##### **Step 3.4.2: 個人專案卡牌頁面**
- [ ] 創建 PersonalProjects 頁面
- [ ] 整合 PersonalProjectsGallery 組件
- [ ] 配置個人專案路由
- [ ] 確保召喚動畫正常運作
...
- [ ] **跨平台互動模式優化**
  - [ ] 桌面端完整體驗（滑鼠點擊、滾輪滾動、鍵盤導航）
  - [ ] 移動端觸控優化（觸控點擊、觸控滾動、手勢支援）
  - [ ] 平板端混合模式（觸控+鍵盤、橫豎屏自動適配）
  - [ ] 統一的互動體驗設計
...
#### Step 4.4: 技能系統進階功能 🔧 **延後至性能優化階段**

**原 Step 3.3.3: 技能導航與篩選** - 移至此處作為進階優化功能

**桌面端進階功能**
- [ ] 添加技能樹縮略圖導航
- [ ] 實現技能狀態篩選（已掌握/學習中/待學習）
- [ ] 添加技能類別快速跳轉
- [ ] 實現技能搜尋高亮功能
- [ ] 優化視窗縮放和定位控制
...
> **💡 設計決策**: 將技能導航與篩選功能延後至 Step 4 性能優化階段，理由如下：
> 1. **核心功能已完備**: Step 3.3.2 已實現完整的技能詳情系統，用戶體驗良好
> 2. **優化性質功能**: 導航和篩選屬於用戶體驗優化，非核心業務功能
> 3. **開發優先級**: 優先完成專案頁面整合，形成完整的網站體驗
> 4. **測試驅動**: 在完成主要頁面後，基於用戶反饋決定是否需要這些進階功能
