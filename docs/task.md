...
- [x] 實現專案時間節點系統 ✅
  ...
  - [x] 時間軸曲線路徑設計 ✅
    ...
    - [x] 路徑動畫 (2秒漸進式描邊效果)
- [ ] 時間軸視覺增強效果
  - [ ] 背景粒子流動系統 (GSAP + Canvas)
  - [ ] 年份/時期標記動態顯示
  - [ ] 時間刻度智能標注
- [ ] 節點分類與標識系統
  - [ ] 專案類型圖標系統 (前端/後端/全端/DevOps)
  - [ ] 時期色彩主題 (近期活躍/歷史沉澱)
...
#### Step 2.2.4: 響應式互動時間軸系統 📱 跨平台支援

- [ ] 移動端垂直時間軸 (max-width: 768px)
  - [ ] 上下滾動時間軸佈局
  - [ ] 觸控拖曳與滑動手勢
  - [ ] 節點卡片飛出適配 (縮小軌跡)
  - [ ] 簡化粒子效果 (效能考量)
- [ ] 桌面端水平時間軸 (min-width: 769px)  
  - [ ] 左右滾動時間軸佈局
  - [ ] 滑鼠滾輪縮放支援
  - [ ] 完整節點飛出動畫展示
  - [ ] 豐富的視覺特效系統
- [ ] 平板端混合模式 (768px-1024px)
  - [ ] 智能佈局切換
  - [ ] 觸控與滑鼠混合操作
  - [ ] 自適應動畫強度
...
- [ ] 移植召喚特效系統
  - [ ] 將 POC-003 完整特效系統遷移
  - [ ] MagicCircle 魔法陣組件整合
  - [ ] ParticleSystem 粒子系統整合
  - [ ] CardSummoning 卡牌召喚整合
  - [ ] AnimationController 動畫控制器整合
