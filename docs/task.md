...
- [ ] 技能分支系統
  - [ ] 後端核心分支 (Backend Core)
  - [ ] 系統架構分支 (System Architecture)
  - [ ] 雲端架構分支 (Cloud Architecture)
  - [ ] AI/ML 工程分支 (AI/ML Engineering)
  - [ ] 資料工程分支 (Data Engineering)
  - [ ] 安全架構分支 (Security Architecture)
  - [ ] 技術領導分支 (Tech Leadership)
