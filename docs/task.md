...
- [ ] 移植并升級 POC-001 技能樹到新架構
  - [ ] 將 POC-001 代碼遷移到新組件結構
  - [ ] 整合到 BaseComponent 基類
  - [ ] 適配新的配置系統
  - [ ] 重構為配置驅動模式
...
- [ ] 配置驅動的技能數據 (依賴 Step 1.3 配置系統)
  - [ ] 使用已建立的 `config/data/skills.data.js`
    - [ ] 技能樹結構定義
    - [ ] 技能節點詳細數據
    - [ ] 技能分支定義
    - [ ] 前置技能關係
