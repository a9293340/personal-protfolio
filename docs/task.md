...
**5.1.2: 聯絡資訊配置** ⏳ **進行中**
- [ ] `config/data/contact/contact.config.js` 內容完善
  - [ ] 聯絡表單配置（表單欄位、驗證規則）
  - [ ] 社交連結整合（與 social.data.js 對接）
  - [ ] 聯絡方式有效性驗證
- [ ] `config/data/social.data.js` 社交連結更新
  - [ ] GitHub 個人資料連結
  - [ ] LinkedIn 資料連結
  - [ ] 其他社交平台連結（Twitter、Medium、個人部落格等）
  - [ ] 專業形象一致性檢查

**5.1.3: 首頁配置** 📝 **待處理**
- [ ] `config/data/home/hero.data.js` Hero 區域配置
  - [ ] 個人介紹文案優化
  - [ ] CTA 按鈕配置
  - [ ] 背景視覺效果設定
- [ ] `config/data/home/preview.data.js` 預覽區塊配置
  - [ ] 技能樹預覽內容
  - [ ] 時間軸預覽內容
  - [ ] 專案卡片預覽內容

**5.1.4: 技能數據配置** 📊 **待處理**
- [ ] `config/data/skills.data.js` 技能樹數據完善
  - [ ] 技能熟練度準確評估（0-100%）
  - [ ] 技能學習歷程詳細描述
  - [ ] 相關工作經驗和專案關聯
  - [ ] 技能分支結構優化
...
**5.1.5: 專案資料配置** 💼 **進行中**
- [ ] `config/data/work-projects/projects.data.js` 工作專案完善
  - [ ] 工作項目詳細描述
  - [ ] 項目技術棧準確描述
  - [ ] 項目成果和影響力量化
  - [ ] 專案稀有度和重要性評分
  - [ ] 專案分類和標籤整理
- [x] `config/data/personal-projects/projects.data.js` 個人專案完善 ✅ **已完成 3 個專案**
