...
export const projectsDataConfig = {
  ...
  all: {
    ...
    "microservices-ecommerce": {
      ...
      // 基本資訊
      shortDescription: "大型電商平台的微服務架構設計與實現，支援高併發與彈性擴展",
      fullDescription: `
      ...
      links: {
        ...
        article: "https://medium.com/@username/microservices-ecommerce-architecture"
      },
    ...
    "config-driven-cms": {
      ...
      shortDescription: "完全配置驅動的無頭 CMS 系統，支援動態表單和內容類型定義",
