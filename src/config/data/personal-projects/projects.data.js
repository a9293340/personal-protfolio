...
export const personalProjectsData = [
  {
    ...
    title: '🌟 AI 智能聊天助手',
    description:
      '基於 OpenAI GPT 模型的智能對話系統，支援多輪對話、上下文理解、情感分析和個性化回應。整合語音識別和文字轉語音功能。',
    category: 'ai',
    rarity: 'legendary',
    status: 'completed',
    importance: 10,
...

  {
    ...
    title: '⚡ 加密貨幣投資組合追蹤器',
    description:
      '全功能加密貨幣投資組合管理應用，支援多交易所 API 整合、實時價格追蹤、收益分析、風險評估和自動化交易策略。',
    category: 'blockchain',
    rarity: 'legendary',
    status: 'completed',
    importance: 9,
...

  {
    ...
    title: '💪 AI 健身私人教練',
    description:
      'React Native 開發的智能健身應用，使用電腦視覺技術分析動作姿態，提供即時反饋和個人化訓練計畫。',
    category: 'mobile',
    rarity: 'superRare',
    status: 'completed',
    importance: 8,
...

  {
    ...
    title: '🎮 遊戲化個人作品集網站',
    description:
      '融合流亡黯道技能樹和遊戲王召喚系統的創新作品集網站，展現全端開發技能和創意設計能力。',
    category: 'frontend',
    rarity: 'legendary',
    status: 'inProgress',
    importance: 10,
...

  {
    ...
    title: '🤝 即時協作白板工具',
    description:
      '多人即時協作的數位白板應用，支援繪圖、文字、圖片、視訊通話，適用於遠程會議、教學和創意發想。',
    category: 'fullstack',
    rarity: 'superRare',
    status: 'completed',
    importance: 7,
...

  {
    ...
    title: '🏠 智慧家居控制面板',
    description:
      '整合多品牌智慧家居設備的統一控制面板，支援場景自動化、語音控制、能源監控和安全警報。',
    category: 'fullstack',
    rarity: 'rare',
    status: 'completed',
    importance: 6,
...

  {
    ...
    title: '📈 AI 股票分析機器人',
    description:
      '使用機器學習和自然語言處理技術分析股市新聞、財報和技術指標，提供投資建議和風險評估。',
    category: 'ai',
    rarity: 'superRare',
    status: 'completed',
    importance: 8,
...

  {
    ...
    title: '🍳 AI 食譜推薦應用',
    description:
      'Flutter 開發的智能食譜推薦應用，根據用戶偏好、營養需求、現有食材和健康目標推薦個性化料理。',
    category: 'mobile',
    rarity: 'rare',
    status: 'completed',
    importance: 5,
...

  {
    ...
    title: '📝 靜態部落格生成器',
    description:
      'Go 語言開發的高性能靜態部落格生成器，支援 Markdown、主題系統、SEO 優化和多語言內容管理。',
    category: 'backend',
    rarity: 'rare',
    status: 'completed',
    importance: 4,
...

  {
    ...
    title: '🔐 跨平台密碼管理器',
    description:
      '使用 Electron 和 React 開發的安全密碼管理應用，支援端到端加密、生物識別解鎖和多設備同步。',
    category: 'fullstack',
    rarity: 'normal',
    status: 'completed',
    importance: 3,
    ...
    images: {
      thumbnail: null, // 使用預設圖標
      screenshots: ['/images/personal-projects/password-manager/vault.jpg'],
    },
