      ...
      properties: {
        frontend: {
          ...
          properties: {
            ...
            direction: { type: 'number', constraints: { min: 0, max: 360 }, required: true },
    ...
    proficiencyLevels: {
      ...
      properties: {
        expert: {
          ...
          required: true,
          properties: {
            symbol: { type: 'string', constraints: { min: 1, max: 1 }, required: true },
            name: { type: 'string', required: true },
            opacity: { type: 'number', constraints: { min: 0, max: 1 }, required: true },
            color: { type: 'string', validator: 'color', required: true },
            description: { type: 'string', required: false }
          }
        },
      ...
      items: {
        ...
        properties: {
          ...
          domain: { 
            type: 'string', 
            required: true,
            constraints: { enum: ['frontend', 'backend', 'database', 'cloud-devops', 'ai', 'architecture'] }
          },
          level: { 
            type: 'string', 
            required: true,
